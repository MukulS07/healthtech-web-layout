...
export const Route = createFileRoute("/doctors/")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Browse verified specialist surgeons across 45+ cities. Filter by specialty, city and experience, stored in MongoDB." },
    ],
  }),
            ...
            <div className="flex flex-wrap items-center justify-between gap-4">
              <div>
                ...
                <p className="mt-3 max-w-xl text-sm text-navy-foreground/75 sm:text-base">
                  Verified specialists across top specialties and cities powered directly by MongoDB. All with 5+ years of surgical experience.
                </p>
              </div>
        ...
        <section className="py-10">
          <Container>
            <div className="mb-6 flex items-center justify-between">
              <p className="text-sm text-muted-foreground">{doctors.length} doctors found in MongoDB database</p>
              {isLoading && (
            ...
            {doctors.length === 0 ? (
              <div className="py-16 text-center">
                ...
                <p className="mt-3 text-muted-foreground">No doctors match your criteria in MongoDB. Try broadening your search.</p>
              </div>
            ) : (
              <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                {doctors.map((d, index) => {
                  ...
                  return (
                    <article key={d.slug || d.id} className="overflow-hidden rounded-lg border border-border bg-background shadow-sm transition-shadow hover:shadow-md">
                      <div className="relative">
                        <img src={avatar} alt={d.name} loading="lazy" width={700} height={700} className="h-52 w-full object-cover" />
