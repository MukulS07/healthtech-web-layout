...
const treatmentData: Record<string, TreatmentInfo> = {
  "piles-surgery": {
    ...
    about:
      "Piles (haemorrhoids) are swollen veins in or around the rectum. Our laser proctoplasty procedure offers a painless, scarless alternative to traditional surgery — most patients return home the same day and are back at work within 3 days.",
    symptoms: [
    ...
    procedures: [
      {
        name: "Laser Proctoplasty",
        desc: "A focused laser beam shrinks the haemorrhoid tissue. No incisions, minimal pain, quick recovery.",
        tag: "Most Popular",
      },
      {
        name: "MIPH (Stapler)",
        desc: "A circular stapler removes excess rectal tissue and repositions the haemorrhoids. Suitable for Grade 3 & 4.",
        tag: "Grade 3–4",
      },
      {
        name: "Open Haemorrhoidectomy",
        desc: "Traditional surgical removal under anaesthesia. Reserved for severe or recurring cases.",
        tag: "Severe Cases",
      },
    ],
    costMin: "₹30,000",
    ...
    faqs: [
      {
        ...
        a: "Laser piles surgery is nearly painless. Most patients report only mild discomfort for 1–2 days after the procedure.",
      },
      {
        q: "How long does recovery take?",
        a: "Most patients return to desk work within 2–3 days and resume full activity within a week.",
      },
      {
        q: "Will my insurance cover it?",
        a: "Yes, piles surgery is covered by most health insurance plans. Our insurance desk confirms your coverage within 30 minutes.",
      },
      {
        q: "Can piles come back after surgery?",
        a: "Laser treatment has a recurrence rate below 2%. Following post-operative diet advice significantly reduces the risk.",
      },
    ],
  },
};
...
const fallback: TreatmentInfo = {
  ...
  about:
    "Our specialists use the latest minimally invasive techniques to ensure safe, effective treatment with minimal downtime. Every patient has a dedicated care coordinator from consultation to recovery.",
  symptoms: [
    "Pain or discomfort",
  ...
  procedures: [
    {
      ...
      desc: "Laparoscopic or laser approach for most patients. Small incisions, fast recovery.",
      tag: "Recommended",
    },
    {
      name: "Standard Surgical",
      desc: "Open surgical approach for complex presentations.",
      tag: "Complex Cases",
    },
    {
      name: "Day-Care Procedure",
      desc: "Same-day discharge where clinically appropriate.",
      tag: "Fast Recovery",
    },
  ],
  costMin: "₹30,000",
  ...
  faqs: [
    {
      ...
      a: "Yes. Your first specialist consultation, including diagnosis and treatment planning, is completely free.",
    },
    {
      q: "Does insurance cover this?",
      a: "We are cashless on 100+ insurers. Our desk confirms coverage within 30 minutes of receiving your policy details.",
    },
    {
      q: "How long is the recovery?",
      a: "Most minimally invasive procedures allow discharge within 24 hours and return to routine in 3–7 days.",
    },
  ],
};
      ...
      <main>
        <nav className="border-b border-border bg-cream py-3 text-xs text-muted-foreground">
          <Container className="flex items-center gap-2">
            ...
            <span>/</span>
            <a href="/treatments" className="hover:text-brand-orange">
              Treatments
            </a>
            <span>/</span>
        ...
        <section className="bg-navy py-12">
          <Container>
            ...
            <p className="mt-3 max-w-xl text-sm text-navy-foreground/80 sm:text-base">
              {data.headline}
            </p>
        ...
        <Container className="grid gap-10 py-12 lg:grid-cols-[1.4fr_0.8fr]">
          <div className="min-w-0 space-y-12">
            ...
            <section className="rounded-xl bg-cream p-6">
              ...
              <p className="mt-2 text-3xl font-extrabold text-brand-orange">
                {data.costMin} – {data.costMax}
              </p>
              <p className="mt-1 text-sm text-muted-foreground">
                Varies by city, facility and procedure type. Cashless on 100+ insurers.
              </p>
            ...
            <section>
              ...
              <Carousel className="mt-5">
                {doctors.map((d) => (
                  <article
                    key={d.name}
                    className="w-[240px] shrink-0 snap-start overflow-hidden rounded-lg border border-border bg-background sm:w-[280px]"
                  >
                ...
                {data.faqs.map((f, i) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <ChevronDown
                        className={`h-5 w-5 shrink-0 text-brand-orange transition-transform ${openFaq === i ? "rotate-180" : ""}`}
                      />
                    </button>
                    {openFaq === i && (
