...
const fallbackHospital: HospitalInfo = {
  ...
  about:
    "A modern multi-specialty surgical centre with advanced equipment, experienced surgeons and a strong commitment to patient safety and comfort.",
  img: hospital2,
};
            ...
            <Container className="pb-8">
              <div className="flex flex-wrap items-center gap-2">
                {data.accreditations.map((a) => (
                  <span
                    key={a}
                    className="rounded-full bg-brand-orange-soft px-3 py-1 text-[11px] font-semibold text-brand-orange-dark"
                  >
                    {a}
                  </span>
                ))}
            ...
            <section>
              ...
              <div className="mt-4 grid gap-3 sm:grid-cols-2">
                {data.facilities.map((f) => (
                  <div
                    key={f.label}
                    className="flex items-center gap-3 rounded-lg border border-border bg-cream px-4 py-3"
                  >
          ...
          <aside className="lg:sticky lg:top-24 lg:self-start">
            ...
            <div className="mt-4 rounded-lg border border-border bg-cream p-4 text-xs text-muted-foreground">
              ...
              <a
                ...
                className="mt-1 flex items-center gap-2 text-sm font-bold text-brand-orange"
              >
