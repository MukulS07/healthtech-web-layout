...
const specialtyData: Record<string, SpecialtyInfo> = {
  proctology: {
    ...
    about:
      "Our proctology specialists handle the full spectrum of colorectal conditions — from piles and fissures to pilonidal sinus and rectal prolapse. We use advanced laser and minimally invasive techniques that reduce pain, eliminate visible scars and enable rapid recovery.",
    stats: [
      { value: "50,000+", label: "Procedures Done" },
      { value: "98%", label: "Success Rate" },
      { value: "3 Days", label: "Average Recovery" },
    ...
    treatments: [
      {
        name: "Piles Surgery",
        slug: "piles-surgery",
        desc: "Laser proctoplasty or MIPH for all grades of haemorrhoids.",
      },
      {
        name: "Anal Fissure Treatment",
        slug: "anal-fissure",
        desc: "Laser sphincterotomy — painless, no cuts, heals in days.",
      },
      {
        name: "Fistula Treatment",
        slug: "fistula-treatment",
        desc: "VAAFT / laser treatment with zero recurrence risk.",
      },
      {
        name: "Pilonidal Sinus",
        slug: "pilonidal-sinus",
        desc: "Laser ablation for the chronic cyst at the base of the spine.",
      },
      {
        name: "Rectal Prolapse Repair",
        slug: "rectal-prolapse",
        desc: "Laparoscopic rectopexy for prolapsed rectum correction.",
      },
      {
        name: "Circumcision",
        slug: "circumcision",
        desc: "Laser circumcision — sterile, painless and quick.",
      },
    ],
    conditions: [
...
const fallbackSpecialty: SpecialtyInfo = {
  ...
  about:
    "Our specialists use the most advanced techniques in this field, with an emphasis on patient safety, minimal downtime and clear communication throughout the care journey.",
  stats: [
    { value: "10,000+", label: "Procedures Done" },
    { value: "97%", label: "Success Rate" },
    { value: "24–48 hrs", label: "Discharge Time" },
    { value: "50+", label: "Specialists" },
  ],
  treatments: [
    {
      name: "Primary Procedure",
      slug: "primary-procedure",
      desc: "The most common surgical approach for this specialty.",
    },
    {
      name: "Advanced Technique",
      slug: "advanced-technique",
      desc: "Minimally invasive option for eligible patients.",
    },
    {
      name: "Corrective Surgery",
      slug: "corrective-surgery",
      desc: "For recurrent or complex presentations.",
    },
  ],
  conditions: [
    "Condition A",
              ...
              <section>
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {data.conditions.map((c) => (
                    <span
                      key={c}
                      className="rounded-full bg-cream px-4 py-2 text-sm font-medium text-ink/80 border border-border"
                    >
                      {c}
                    </span>
                  ))}
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <div className="mt-3 flex gap-2">
                          ...
                          <OrangeButton className="flex-1 px-2 py-1.5 text-xs">
                            Book Now
                          </OrangeButton>
                        </div>
                      </div>
