...
const sections = [
  {
    ...
    content: `By accessing or using the Go Surgery website (gosurgery.in) or any of our services, you agree to be bound by these Terms of Use. If you do not agree to these terms, please do not use our website or services.
...
These Terms apply to all visitors, users and others who access or use the service. We may update these Terms from time to time. Continued use of our services after any changes constitutes acceptance of the revised Terms.`,
  },
  {
    ...
    content: `Go Surgery is a healthcare facilitation platform. We connect patients with specialist surgeons, partner hospitals and insurance providers. We are not a hospital, clinic or medical institution.

Go Surgery does not provide medical diagnosis or treatment directly. All clinical decisions, diagnoses and treatment plans are made by qualified, registered medical professionals in our partner network.
...
Go Surgery facilitates cashless insurance processing but does not guarantee insurance approval. Insurance decisions are made by the respective insurer.
...
Refund policies for advance payments are governed by the specific terms communicated at the time of booking. Contact care@gosurgery.in for refund queries.`,
  },
  {
    title: "User Conduct",
    content: `When using Go Surgery's website or services, you agree not to:
...
We reserve the right to terminate access for any user who violates these terms.`,
  },
  {
    ...
    content: `All content on this website — including text, graphics, logos, images, treatment guides and software — is the property of Go Surgery Health Pvt. Ltd. and is protected by applicable intellectual property laws.

You may not reproduce, distribute, modify or create derivative works from our content without prior written permission. Linking to our website is permitted provided it is done in a manner that does not misrepresent Go Surgery or suggest a commercial relationship.`,
  },
  {
...
Go Surgery has no control over third-party websites and is not responsible for their content, privacy practices or terms. We encourage you to review the terms and privacy policies of any third-party sites you visit.`,
  },
  {
    title: "Limitation of Liability",
    content: `To the fullest extent permitted by applicable law, Go Surgery shall not be liable for:
...
Our maximum aggregate liability for any claim related to these Terms shall not exceed the amount paid by you to Go Surgery in the three months preceding the claim.`,
  },
  {
    title: "Disclaimers",
    content: `Go Surgery's website and services are provided "as is" and "as available" without warranties of any kind, express or implied. We do not warrant that the website will be error-free, uninterrupted or free of viruses.
...
Before initiating legal proceedings, we encourage you to contact our care team at care@gosurgery.in to resolve any concerns informally. Most issues can be resolved quickly through direct communication.`,
  },
  {
    title: "Contact",
        ...
        <section className="py-14">
          <Container className="max-w-3xl">
            <p className="text-sm leading-relaxed text-muted-foreground sm:text-base">
              Please read these Terms of Use carefully before using Go Surgery's website or
