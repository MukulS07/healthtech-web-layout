...
const allPosts = [
  ...
  },
  {
    ...
    cat: "Recovery",
    author: "Dr. Pradeep Dutta",
    date: "Aug 28, 2026",
    read: "4 min read",
    excerpt:
      "Nutrition plays a crucial role in surgical recovery. A dietitian and surgeon walk through the ideal first-week plan.",
  },
  {
    ...
    date: "Aug 22, 2026",
    read: "6 min read",
    excerpt: "Insurance jargon made simple — from pre-authorisation to final discharge clearance.",
  },
  {
    ...
    read: "7 min read",
    excerpt:
      "We address 7 of the most common misconceptions about knee replacement surgery and recovery.",
  },
  {
    title: "Understanding laparoscopy: what you're not told",
    ...
    read: "5 min read",
    excerpt:
      "A frank look at what laparoscopic surgery involves — before, during and after the theatre.",
  },
  {
    title: "PCOS and surgery: when medication isn't enough",
    ...
    read: "6 min read",
    excerpt:
      "A comprehensive guide to surgical options for PCOS, when to consider them, and what recovery looks like.",
  },
  {
    title: "Kidney stones: shock wave vs laser vs surgery",
    ...
    read: "8 min read",
    excerpt:
      "Three common treatment paths for kidney stones — compared by stone size, position and patient fitness.",
  },
  {
    ...
    read: "4 min read",
    excerpt:
      "From ice chips to medication timing — a practical checklist for the first ten days after tonsil removal.",
  },
  {
    title: "Why fibre matters more after colorectal surgery",
    ...
    read: "3 min read",
    excerpt:
      "Diet directly affects healing after any colorectal procedure. Here's the science and the practical list.",
  },
  {
    title: "Varicose veins: compression stockings or EVLA?",
    ...
    read: "5 min read",
    excerpt:
      "Conservative management vs. laser ablation — which approach works, for which patients.",
  },
  {
    title: "How anaesthesia is chosen for day-care surgeries",
    ...
    read: "5 min read",
    excerpt:
      "Local, regional or general — the anaesthesia decision depends on more than just the procedure.",
  },
  {
    ...
    read: "4 min read",
    excerpt:
      "This straightforward checklist covers everything from blood work to what to stop eating — and why each item matters.",
  },
];
  ...
  head: () => ({
    meta: [
      { title: "Healthfeed — Surgical & Health Articles | Prime Care" },
      {
        name: "description",
        content:
          "Doctor-reviewed guides on treatments, surgery recovery and insurance. Written for patients, not clinicians.",
      },
    ],
  }),
  component: BlogPage,
...
function BlogPage() {
  ...
  const filtered =
    activeCategory === "All" ? allPosts : allPosts.filter((p) => p.cat === activeCategory);
        ...
        <section className="bg-navy py-14">
          <Container>
            ...
            <h1 className="mt-2 text-3xl font-bold text-navy-foreground sm:text-4xl">
              Read, Learn & Decide Better
            </h1>
            <p className="mt-3 max-w-xl text-sm text-navy-foreground/75 sm:text-base">
              Doctor-reviewed guides on treatments, recovery and insurance — written for patients,
              not clinicians.
            </p>
          </Container>
        </section>
